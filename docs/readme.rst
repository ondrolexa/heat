...
equation on grids with constant or variable properties.
...
Uniform grids with constant properties
======================================
...
-  ``SteadyState_Constant_1D`` - Steady state heat equation solution on
   1D grid with constant properties
-  ``BTCS_Constant_1D`` - Evolutionary heat equation solution on 1D grid
...
Non-uniform grids with variable properties
==========================================
